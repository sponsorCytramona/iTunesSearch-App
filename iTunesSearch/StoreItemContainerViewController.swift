...
class StoreItemContainerViewController: UIViewController, UISearchResultsUpdating {
    ...
    var tableViewDataSource: StroreItemTableViewDiffableDataSource!
    ...
    func configureTableViewDataSource(_ tableView: UITableView) {
        tableViewDataSource = StroreItemTableViewDiffableDataSource(tableView: tableView, cellProvider: { tableView, indexPath, itemIdentifier -> UITableViewCell in
    ...
    func handleFetchedItems(_ storeItems: [StoreItem]) async {
        let currentSnapshotItems = itemsSnapshot.itemIdentifiers
        let updatedSnapshot = createSectionedSnapsot(from: currentSnapshotItems + storeItems)
    ...
    func createSectionedSnapsot(from items: [StoreItem]) -> NSDiffableDataSourceSnapshot<String, StoreItem> {
